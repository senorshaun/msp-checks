...
--
-- Dumping data for table `template_steps`
--

LOCK TABLES `template_steps` WRITE;
/*!40000 ALTER TABLE `template_steps` DISABLE KEYS */;
INSERT INTO `template_steps` VALUES (2,2,1,'Clean Server Fans',NULL,1,'2026-04-14 23:08:28');
/*!40000 ALTER TABLE `template_steps` ENABLE KEYS */;
UNLOCK TABLES;
